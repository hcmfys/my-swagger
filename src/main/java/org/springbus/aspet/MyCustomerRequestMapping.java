...
@Component
@Qualifier(value = "MyCustomerRequestMapping")
@Slf4j
public class MyCustomerRequestMapping extends RequestMappingInfoHandlerMapping
    ...
    protected RequestMappingInfo getMappingForMethod(Method method, Class<?> handlerType) {
        ...
        log.info("=======getMappingForMethod ======>{}",info);
        return info;
    }
