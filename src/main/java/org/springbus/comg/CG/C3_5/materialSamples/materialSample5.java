package org.springbus.comg.CG.C3_5.materialSamples;
...
// materialSample5.java （材質感のテスト用プログラム：アプレット）
//	図３−２４
...
public class materialSample5 extends JApplet {
	...
	public void init(){
		...
		mat2.setDiffuseColor(0,0.3,0.8);//拡散反射光成分の設定
		mat2.setSpecularColor(1,1,1);//鏡面反射光成分の設定
		mat2.setShininess(120.0);//光沢度の設定
		mat2.setReflection(0.1);//「写り込み」係数の設定
		mat2.setTransparency(0.5);//透過率の設定
		mat2.setRefraction(1.0);//屈折率の設定
